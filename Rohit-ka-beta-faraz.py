...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\r\033[1;37m[M•A•N•I] {}\033[1;93m<•>\033[1;97mOK : \033[1;92m{} \033[1;93mCP : \033[1;97m{} \033[1;92m[\033[1;93m{}\033[1;92m]  \r'.format(str(loop) , str(len(okacc)) ,str(len(cpacc))),pers)
        sys.stdout.flush()
